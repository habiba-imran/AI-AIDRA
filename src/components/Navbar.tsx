  ...
  return (
    <nav className="h-[60px] flex items-center justify-between px-5 bg-[#0a0f1e] border-b border-[#1e293b] shrink-0 z-50">
      ...
      <div className="flex items-center gap-4 shrink-0">
        ...
        <span className="font-mono-display text-[#22c55e] text-[13px] font-medium">T+ 00:07:23</span>
        <div className="relative cursor-pointer">
          <Bell className="w-5 h-5 text-[#94a3b8] hover:text-[#f1f5f9] transition-colors" />
          <span className="absolute -top-1.5 -right-1.5 w-4 h-4 rounded-full bg-red-500 text-[9px] text-[#f1f5f9] flex items-center justify-center font-bold badge-glow-red">3</span>
        </div>
